...
export function AnalyticsPreferences() {
  ...
  return <section className="rounded-3xl border border-border bg-card p-6 shadow-sm">
    <div className="flex items-start gap-3"><BarChart3 size={22} className="mt-1 text-secondary" /><div><h2 className="text-xl font-semibold text-foreground">Analítica de producto</h2><p className="mt-1 text-sm text-muted-foreground">{enabled ? "Activa: recibimos solo eventos técnicos de uso." : "Desactivada: no enviamos eventos de uso."}</p></div></div>
