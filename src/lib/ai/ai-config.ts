...
const DEFAULT_TICKET_PRIMARY_MODEL = "gpt-4o-mini";
const DEFAULT_TICKET_FALLBACK_MODEL = "gpt-4o";
const DEFAULT_REPORT_PRIMARY_MODEL = "gpt-4o-mini";
const DEFAULT_REPORT_FALLBACK_MODEL = "gpt-4o";
