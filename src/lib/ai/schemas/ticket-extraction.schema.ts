...
export const aiTicketExtractionJsonSchema = {
  ...
  properties: {
    ...
    betType: { type: ["string", "null"] }, stake: { type: ["number", "null"] }, odds: { type: ["number", "null"] }, currency: { type: ["string", "null"] }, potentialPayout: { type: ["number", "null"] }, result: { type: ["string", "null"] }, netProfit: { type: ["number", "null"] }, ticketCode: { type: ["string", "null"] }, notes: { type: ["string", "null"] }, confidenceScore: { type: "number" }, doubtfulFields: { type: "array", items: { type: "string" } }, legs: { type: ["array", "null"], minItems: 1, maxItems: 20, items: aiTicketLegJsonSchema },
  },
} as const;
